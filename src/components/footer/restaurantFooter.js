...
class RestaurantFooter extends Component {
  render() {
    return (
      <>
          ...
          <div className="container" style={{ marginTop: "35px" }}>
            <div className="row">
              <div className="col-md-3">
                ...
                <label className="txt">for Restaurants</label>
              </div>
              <div
              ...
              >
                ...
                <label className="txt">
                  Download Uber Eats Modern Slavery Act Transparency
                </label>
                <br />
                <label className="txt">Statement</label>
              </div>
            </div>
            <div>
